...
#ifndef chconf_teensy4_h
#define chconf_teensy4_h
 ...
 */
#if USE_TEENSY4_PERIODIC_ST  // WHG
 ...
 */
#if USE_TEENSY4_PERIODIC_ST  // WHG - use round robin if periodic
